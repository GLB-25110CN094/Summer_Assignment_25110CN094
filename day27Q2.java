...
public class day27Q2 {
    public static void main(String[] args) {
        Scanner sc=new Scanner(System.in);
         ArrayList<Employee>employees = new ArrayList<>();
         //array list for storing data of student 
        employees.add(new Employee(101, "Rahul", "editor", 23456.0));
        employees.add(new Employee(102, "Priya", "manager", 78864.0));
        employees.add(new Employee(103, "Amit", "HR", 32344.3));
         int choice=0;
